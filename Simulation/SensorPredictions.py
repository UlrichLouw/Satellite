...
class SensorPredictionsDMD:
    def __init__(self, sensors_X):
        ...
        self.DMD_Prediction_A = np.load(SET_PARAMS.pathHyperParameters + 'PhysicsEnabledDMDMethod/' + str(SET_PARAMS.sensor_number) + 'A_matrixs.npy')
        self.DMD_Prediction_B = np.load(SET_PARAMS.pathHyperParameters + 'PhysicsEnabledDMDMethod/' + str(SET_PARAMS.sensor_number) + 'B_matrixs.npy')
